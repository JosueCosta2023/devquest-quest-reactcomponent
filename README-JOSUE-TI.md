# Getting started Styling in components

Este projeto foi inicializado com [Create React App](https://github.com/facebook/create-react-app).

## About Project
#### Objetivo base, treino de React Básico.

* Criar um componente button que ao clicar exiba um alert com a mensagem "O label deste projeto é, BAIXAR CV"
* Criar um componente que estilize um paragrafo, a estilização deve ser, alterar cor do texto e transformar todo o texto em letras maiúsculas.

## Result
![Desktop](./quest/react.gif)
